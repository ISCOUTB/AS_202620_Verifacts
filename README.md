...
Las secciones 13 a 16 documentan, paso a paso, el único recorrido de extremo
a extremo que hoy es ejecutable en VeriFacts: arrancar el servicio,
confirmar que responde y verificarlo con una prueba automatizada (local y
en CI). Este es el corte vertical de este incremento — ver también su
descripción arquitectónica en
[Sección 6 — Vista de ejecución](docs/arc42/06-vista-de-ejecucion.md) y su
trazabilidad hasta la evidencia de prueba en la fila **A-00** de la
